...
# Adapted Tensorflow Object Detection API

This repository is a copy of the code relevant for object detection from the 
original tensorflow/models repository on github.

## Instructions

* Follow installation instructions below and build the code base
* Download the required checkpoint and graph files from the model_zoo
* Change the checkpoint file names and the test_images location in `demo.py`
* Set environment variables in `run.sh` and execute it
